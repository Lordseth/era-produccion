...
$sql = "SELECT productividad_fecha, productividad_orden_trabajo, productividad_nombre_pieza, productividad_operacion_nombre, productividad_nombre_empleado, tiempo_real, tiempo_disponible, unidades_producidas, unidades_estimadas, productividad_total, productividad_comentarios FROM productividad";
...
$hojaActiva->setCellValue('E1', 'nombre de operador');
...
$hojaActiva->setCellValue('J1', 'productividad');
$hojaActiva->setCellValue('K1', 'comentarios');
...
while($rows = $resultado->fetch_assoc()) {
    ...
    $hojaActiva->setCellValue('J'.$fila, $rows['productividad_total']);
    $hojaActiva->setCellValue('K'.$fila, $rows['productividad_comentarios']);
