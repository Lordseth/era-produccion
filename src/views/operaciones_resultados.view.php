...
<div class="busqueda-contenedor">
    ...
    <div class="busqueda-formulario">
        <form class="formulario-busqueda" action="<?php echo RUTA; ?>/buscar_operaciones.php" method="get">
            <label class="etiqueta-busqueda" for="buscar">Buscar Operaciones</label>
...
<div class="excel">
    ...
    <a class="link-excel" href="reporte_operaciones_mysqli.php"><img class="excel-logo" src="/src/images/excel-logo.png" alt="logo-png"></a>
</div>
...
<section class="contenedor">
    <div class="operaciones-resultados-grid">
        <?php foreach ($datos as $dato) :  ?>
            <div class="operaciones-resultados">
                ...
                <p><?php echo 'Numero de Orden de Trabajo: ' ?><span class="datos"><?php echo $dato['operaciones_orden_trabajo'] ?></span></p>
    ...
    <?php require 'paginacion_operaciones.php'; ?>
